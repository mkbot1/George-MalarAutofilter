...
from info import ADMINS, PICS_RT, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, DELETE_TIME, CH_FILTER, CH_LINK, OWNER_USERNAME, UPDATES_CHANNEL, GROUP_SUPPORT
    ...
    if query.data.startswith("file"):
        ...
        if CUSTOM_FILE_CAPTION:
            try:
                ...
                buttons = [[
                  InlineKeyboardButton('🔰 Main Group 🔰', url=f'https://t.me/{GROUP_SUPPORT}')
                  ]]
        ...
        try:
            ...
            await query.answer('Check Our "File Channel" For Your File')
        ...
        buttons = [[
            ...
            InlineKeyboardButton('✆ 𝙶𝚁𝙾𝚄𝙿 ✆', url=f'https://t.me/{GROUP_SUPPORT}'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="⚜️ Main Channel ⚜️",url=f"https://t.me/{UPDATES_CHANNEL}"),
             InlineKeyboardButton(text="💢 Main Group 💢",url=f"https://t.me/{GROUP_SUPPORT}")]
        )
        btn.insert(0,
            [InlineKeyboardButton(text="🔶 Files Channel 🔶",url=f"{CH_LINK}")]
        )
    else:
        btn.append(
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="⚜️ Main Channel ⚜️",url=f"https://t.me/{UPDATES_CHANNEL}"),
             InlineKeyboardButton(text="⭕️ MAIN Group ⭕️",url=f"https://t.me/{GROUP_SUPPORT}")]
        )
        btn.insert(0,
            [InlineKeyboardButton(text="🔶 Files Channel 🔶",url=f"{CH_LINK}")]
        )
